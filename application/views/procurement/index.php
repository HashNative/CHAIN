                ...
                <div class="ibox ">
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">
                            <a href="<?php echo base_url('suppliers/create') ?>" class="btn btn-primary btn-xs">Create new Supplier</a>
                            ...
                            <?php if($supplier_data): ?>
                                <?php foreach ($supplier_data as $k => $v): ?>
                                    <tr>
                                        ...
                                        <td class="client-status"><span class="label label-primary">Approved</span></td>
                                        <?php if(in_array('updateSupplier', $user_permission) || in_array('deleteSupplier', $user_permission)): ?>

                                            <td class="text-right">
                                                <?php if(in_array('updateSupplier', $user_permission)): ?>
                                                    <a class="btn-white btn btn-xs" href="<?php echo base_url('suppliers/edit/'.$v['supplier_info']['id']) ?>" ><i class="fa fa-pencil"></i> Edit</a>
                                                <?php endif; ?>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#procurementMainMenu").addClass('active');
    });
  </script>
