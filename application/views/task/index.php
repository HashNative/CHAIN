                    ...
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                            <button type="button" class="btn btn-sm btn-white" data-toggle="modal"
                                                data-target="#createModal"> <i class="fa fa-plus"></i> Add task</button>
                                </span>
                    </div>
                        ...
                        <li class="<?php echo $colors[array_rand($colors)]; ?>">
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <div>
                                    <a href="#" data-toggle="modal"
                                       data-target="#deleteModal<?php echo $v['task_info']['id']; ?>"><i class="fa fa-trash-o "></i></a>
                                </div>
                            </div>
                            <hr>
                            <p>Ingredients:</p>
                            ...
                            <div class="agile-detail">
                                <a href="#" class="float-right btn btn-xs btn-primary" data-toggle="modal"
                                   data-target="#issueModal<?php echo $v['task_info']['id']; ?>">Issue</a>
                                ...
                                <?php if($v['task_info']['status']=='progress'): ?>
                                    <li class="<?php echo $colors[array_rand($colors)]; ?>" id="<?php echo $v['task_info']['id']; ?>">
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <div>
                                                <a href="#" data-toggle="modal"
                                                   data-target="#revertModal<?php echo $v['task_info']['id']; ?>"><i class="fa fa-reply" aria-hidden="true"></i></a>&nbsp&nbsp
                                                <a href="#" data-toggle="modal"
                                                   data-target="#deleteProgressModal<?php echo $v['task_info']['id']; ?>"><i class="fa fa-trash-o "></i></a>
                                            </div>
                                        </div>
                                        <hr>
                                        <p>Ingredients:</p>
                                        ...
                                        <div class="agile-detail">
                                            <a href="#" class="float-right btn btn-xs btn-primary" data-toggle="modal"
                                               data-target="#completeModal<?php echo $v['task_info']['id']; ?>">Complete</a>
