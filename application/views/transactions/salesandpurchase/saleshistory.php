...
<div class="col-lg-4">
    <div class="title-action">
        <a href="<?php echo base_url('sales') ?>" class="btn btn-primary"><i class="fa fa-angle-double-up"></i> New Sale </a>
    </div>
</div>
                        ...
                        <table class="footable table table-stripped" data-page-size="8" data-filter=#filter>
                            ...
                            <?php if($sales_data): ?>
                                <?php foreach ($sales_data as $k => $v): ?>
                                    <tr>
                                        <td>
                                            <?php echo $v['sales_info']['sales_order_no']; ?>
                                        </td>
                                        <td>
                                            <?php echo date('d/m/Y H:i:s', $v['sales_info']['date_time']); ?>
                                        </td>
                                        <td>
